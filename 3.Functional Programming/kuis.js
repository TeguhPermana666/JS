 ...
 */
 ...
 const books = [
  ...
  const greatAuthors = books.filter((bookSold) => {return bookSold.sales > 1000000}).map((bookTitle) =>{ return `${bookTitle.author} adalah penulis buku ${bookTitle.title} yang sangat hebat!`}); 
